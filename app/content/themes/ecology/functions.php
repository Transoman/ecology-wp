...
if ( ! function_exists( 'eco_setup' ) ) :
  ...
  function eco_setup() {
    ...
    register_nav_menus( array(
      'primary' => esc_html__( 'Primary', 'eco' ),
    ) );
 ...
 */
function eco_content_width() {
  // This variable is intended to be overruled from themes.
  // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
  $GLOBALS['content_width'] = apply_filters( 'eco_content_width', 640 );
}
add_action( 'after_setup_theme', 'eco_content_width', 0 );
 ...
 */
function eco_widgets_init() {
  register_sidebar( array(
    'name'          => esc_html__( 'Sidebar', 'eco' ),
    'id'            => 'sidebar-1',
    'description'   => esc_html__( 'Add widgets here.', 'eco' ),
...
add_action( 'widgets_init', 'eco_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function eco_scripts() {
  wp_enqueue_style( 'eco-style', get_stylesheet_uri() );

  wp_enqueue_script( 'eco-main', get_template_directory_uri() . '/js/common.js', array(), '', true);
